...
QrySearch <- function(queryTerm) {
  ...
  term.doc.matrix.stm<-c(data.doc.matrix.stm, query.doc.matrix.stm)
  
  #term.doc.matrix.stm<-c(TermDocumentMatrix(query_corpus),TermDocumentMatrix(my.corpus))
  
  #term.doc.matrix.stm<-c(query.doc.matrix.stm,data.doc.matrix.stm) 
